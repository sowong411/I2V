...
public class VideoSettingActivity extends Activity {
    ...
    String chosenTemplateName = "General";
    int  chosenEffect = 0;
    int chosenTemplate = 0;
    int chosenInnerTemplate = 0;
    String[]  allPath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_next).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("chosenMusicPath", chosenMusicPath);
                bundle.putInt("chosenEffect", chosenEffect);
                bundle.putInt("chosenTemplate", chosenTemplate);
                bundle.putInt("chosenInnerTemplate", chosenInnerTemplate);
    ...
    public void selectTemplate(){
        final Button button = (Button) findViewById(R.id.template);
        button.setText("No Template");
        final String[] templateInList = {"No Template","Christmas","Wedding","Love","Energetic"};
        ...
        templateBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int position) {
                ...
                if (chosenTemplate != 0 && chosenTemplate != 4){
                    final String[] innerTemplateInList = {"Style1", "Style2"};
                    final AlertDialog.Builder innerTemplateBuilder = new AlertDialog.Builder(VideoSettingActivity.this);
                    innerTemplateBuilder.setTitle("Choose Template");
                    innerTemplateBuilder.setSingleChoiceItems(innerTemplateInList, 0, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int position) {
                            chosenInnerTemplate = position;
                        }
                    });
                    innerTemplateBuilder.setPositiveButton("OK", null);
                    innerTemplateBuilder.setNegativeButton("Cancel", null);
                    innerTemplateBuilder.show();
                }
